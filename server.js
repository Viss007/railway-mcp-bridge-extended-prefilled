...
function manifest() {
  return {
    ...
    tools: [
      ...
      { name: "discord.sendMessage", description: "Send a message to a Discord channel (guarded by ALLOW_WRITES).", input_schema: { type: "object", required: ["content"], properties: { channel_id: { type: "string", description: "Target channel ID" }, content: { type: "string", description: "Message content" } }, additionalProperties: false } },
      { name: "github.getUser", description: "Get the authenticated GitHub user.", input_schema: { type: "object", properties: {}, additionalProperties: false } },      { name: "railway.listProjects", description: "List Railway projects (GraphQL).", input_schema: { type: "object", properties: {}, additionalProperties: false } ] }
}
